...
class IndexController extends Controller
{
    ...
    {
        return $this->isReportSupervisor($roleId) || $this->hasGlobalReportAccess($roleId) || $roleId === 8;
    }
    ...
    private function resolvedReportSbu(Request $request): ?string
    {
        ...
        if ($this->isReportSupervisor($roleId) || $roleId === 8) {
            $userSbu = $this->getReportUserSBU() ?: 'SBU3';
