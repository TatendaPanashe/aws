...
@section('content')
    ...
    onclick="allocate(
        '{{ $collection->id }}', '{{ $collection->created_at }}', '{{ $collection->currency }}', '{{ ($collection->bank) }}',   '{{ $collection->insurance_transactions }}',  '{{ $collection->usd_cash }}',
        '{{ $collection->usd_swipe }}',   '{{ $collection->usd_transfers }}',
        '{{ $collection->usd_total_deposited }}',   '{{ $collection->zwg_insurance_transactions }}',
        '{{ $collection->zwg_cash }}','{{ $collection->zwg_swipe }}',
        '{{ $collection->zwg_transfers }}',     '{{ $collection->zwg_total_deposited }}',
