...
<div class="pagetitle">
    ...
    <p>
        <?php if($isZINARAUser): ?>
            ZINARA-focused dashboard for face value management, declarations, and stock tracking.
        <?php else: ?>
    ...
    <div>
        ...
        <p>
            <?php if($isZINARASupervisor): ?>
                Monitor face value stock, allocations to clerks, declaration activity, and spoilage across your ZINARA clerks.
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/Documents/Projects/gruma-5/resources/views/index.blade.php ENDPATH**/ ?>