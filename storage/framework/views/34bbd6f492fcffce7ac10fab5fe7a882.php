    ...
    <div class="card-body">
        <div class="row">
            ...
            <?php if(isset($userSBU) && $userSBU): ?>
                <div class="alert alert-info">
                    ...
                    <strong>Your SBU: <?php echo e($userSBU); ?></strong>
                    <?php if((string) preg_replace('/\s+/', '', strtoupper($userSBU)) === 'SBU3'): ?>
        ...
        <?php if($clerks->isEmpty()): ?>
            <div class="alert alert-warning">
                ...
                <strong>No clerks available for allocation<?php echo e(isset($userSBU) ? ' in your current scope (' . $userSBU . ')' : ''); ?>.</strong><br>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/Documents/Projects/gruma/resources/views/supervisorfacevalues/allocate.blade.php ENDPATH**/ ?>