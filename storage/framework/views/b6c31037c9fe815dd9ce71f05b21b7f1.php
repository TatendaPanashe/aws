...
<section class="front-hero">
  <div class="front-hero-card">
    ...
    <div class="front-hero-actions">
      <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">Open Secure Workspace</a>
...
<?php echo $__env->make('layouts.frontpages', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/Documents/Projects/gruma-5/resources/views/frontpages/index.blade.php ENDPATH**/ ?>