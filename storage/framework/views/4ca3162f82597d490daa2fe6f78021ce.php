            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($hasGlobalVisibility): ?>
                            <td><?php echo e($supervisorfacevalue->owner_name); ?></td>
                        <?php endif; ?>
                        ...
                        <td>
                            <?php if($supervisorfacevalue->balance > 0 && $supervisorfacevalue->can_allocate): ?>
                                <a href="<?php echo e(route('allocate', $supervisorfacevalue->id)); ?>" class="btn btn-primary btn-sm">Allocate</a>
                            <?php elseif($supervisorfacevalue->balance > 0): ?>
                ...
                <tfoot class="table-light">
                    <tr>
                        <th colspan="<?php echo e($hasGlobalVisibility ? 3 : 2); ?>">Totals</th>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/Documents/Projects/app/resources/views/supervisorfacevalues/index.blade.php ENDPATH**/ ?>