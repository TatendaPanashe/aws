...
<?php if (! $__env->hasRenderedOnce('336159dc-ed25-4f11-a672-5dc3ec3dde10')): $__env->markAsRenderedOnce('336159dc-ed25-4f11-a672-5dc3ec3dde10'); ?>
    <style>
        .report-legend {
            display: flex;
            flex-wrap: wrap;
                    ...
                    <table class="table table-striped datatable" id="usdTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><span class="<?php echo e($amountPill($transactions->sum('usd_cash_in_hand_balance'), 'warning')); ?>">$<?php echo e(number_format((float) $transactions->sum('usd_cash_in_hand_balance'), 2)); ?></span></th>
                    ...
                    <table class="table table-striped datatable" id="zwgTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><span class="<?php echo e($amountPill($transactions->sum('zwg_cash_in_hand_balance'), 'warning')); ?>">ZWG <?php echo e(number_format((float) $transactions->sum('zwg_cash_in_hand_balance'), 2)); ?></span></th>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookair/Documents/Projects/gruma/resources/views/Reports/index.blade.php ENDPATH**/ ?>